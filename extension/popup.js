...
3. Lyrics - 構造化された歌詞（🚫翻訳形式絶対禁止🚫、日本語部分は漢字・数字を完全にひらがな化）
...
【🚨🚫 言語比率の絶対的遵守 - 翻訳パターン絶対禁止 🚫🚨】
  ...
  🚫 絶対禁止パターン：
    - 行ごとの翻訳（英語行→日本語行の交互配置）
    - 対訳形式の歌詞構造
    - 同じ内容を両言語で表現
    
  ✅ 英語比率60%以上の場合：
    - パート全体を英語で構築
    - 指定比率に応じて少数の日本語行を自然に散りばめる
    - 日本語行は英語の内容と異なる感情や描写を担当
    
  ✅ 日本語比率60%以上の場合：
    - パート全体を日本語で構築  
    - 指定比率に応じて少数の英語行を自然に散りばめる
    - 英語行は日本語の内容と異なる感情や描写を担当
...
✓ この比率からの逸脱は禁止です
🚫 翻訳パターンの絶対禁止：行ごとの英語→日本語対訳形式
✅ 英語主体（60%以上）：英語でパート構築→少数日本語行を散りばめ
✅ 日本語主体（60%以上）：日本語でパート構築→少数英語行を散りばめ
🎯 各言語行は独立した意味と感情を持つこと（翻訳関係ではない）
