...
### v1.2.0 (2025-01-18)
#### ✨ Major Features
- **プリセット＋カスタムテーマ組み合わせ機能**: プリセットテーマを選択しつつ、追加でカスタムテキストも記述可能
- **カスタムテーマテキスト保持**: モード切り替え時にカスタムテーマのテキストが消えない
- **新UI設計**: テーマモード選択ボタンを廃止し、常に両方利用可能な直感的なUI

#### 🔧 Technical Improvements
- バリデーション処理の改善（プリセット選択orカスタムテキストのどちらかがあればOK）
- テーマ構築処理の最適化（プリセット+カスタムの組み合わせ対応）
- 不要な`isCustomTheme`フラグを削除しコードを簡素化

#### 🎨 UI/UX Improvements
- カスタムテーマエリアのスタイル改善
- 「追加カスタムテーマ（任意）」として位置づけを明確化
- より分かりやすいラベルとヘルプテキスト
